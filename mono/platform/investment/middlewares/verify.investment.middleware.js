...
export function hasValidInsertFields(req, res, next) {
    const validation = {
        fields : ['user_id', 'name', 'type', 'about', 'url', 'phone', 'phoneCode', 'email', 'country', 'created_by'],
        errorCode: '001'
    }
...
export function hasValidUpdateFields(req, res, next) {
    const validation = {
        fields : ['user_id','investment_id', 'name', 'type', 'about', 'url', 'phone','phoneCode', 'email', 'country', 'created_by'],
        errorCode: '007'
    }
    return _validateFields(validation, req, res, next); 
}
